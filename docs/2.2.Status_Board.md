...
### Backlog — 문서/코드 정합성
- **DOC-OPENAPI**: `api/openapi.yml`/`api/versions/v0.1.0.yml`를 최신 컨트롤러 기준으로 재생성하고, `docs/2.1.Demo_Plan.md`, `docs/2.Demo_Scenario.md` 링크를 동기화할 것. 현재 일부 엔드포인트/필드(dedupe 키, allow_background, inspection submit, admin 재배분) 미반영.
