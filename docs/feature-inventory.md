...
## 2. 냉장고 – 일반 기숙사생
*연결 문서: [MVP 시나리오 §3.1](mvp-scenario.md#31-거주자-포장-등록-및-관리), [MVP Plan FR-201](mvp-plan.md#fr-201-슬롯-접근-제어) · [FR-202](mvp-plan.md#fr-202-포장-등록-플로우) · [FR-203](mvp-plan.md#fr-203-임박만료--라벨-재사용)*
...
## 3. 냉장고 – 알림 & 일정
*연결 문서: [MVP 시나리오 §3.3](mvp-scenario.md#33-검사-후-사용자-알림) · [§3.4](mvp-scenario.md#34-임박만료-자동-알림), [MVP Plan NO-401](mvp-plan.md#no-401-검사-결과-알림-발행) · [NO-402](mvp-plan.md#no-402-검사-결과-알림-ui) · [NO-403](mvp-plan.md#no-403-알림-설정-ui) · [NO-501](mvp-plan.md#no-501-배치-알림-생성) · [NO-502](mvp-plan.md#no-502-임박만료-알림-ui)*
...
- **검사 일정**: 다음 검사일 정보를 `/fridge/inspections`에서 제공하고, 일정 저장소는 서버에서 관리한다.
  - *MVP*: 층별장이 자신의 책임 구역 칸을 대상으로 일정 생성/수정/완료 처리를 수행한다.
  - *Post-MVP*: 관리자가 전역 일정 등록·수정을 수행할 수 있도록 확장하고, 생성 시 담당 층별장에게 알림을 발송한다.


---

## 4. 냉장고 – 층별장(검사자)
*연결 문서: [MVP 시나리오 §3.2](mvp-scenario.md#32-층별장-검사-세션-단독-흐름), [MVP Plan IN-301](mvp-plan.md#in-301-검사-시작잠금) · [IN-302](mvp-plan.md#in-302-조치-선택벌점-연동) · [IN-303](mvp-plan.md#in-303-제출-요약잠금-해제)*
...
## 5. 냉장고 – 관리자
*연결 문서: [MVP 시나리오 §3.5](mvp-scenario.md#35-관리자-운영-통제), [MVP Plan AD-601](mvp-plan.md#ad-601-칸-설정통계) · [AD-602](mvp-plan.md#ad-602-역할-관리) · [RG-701](mvp-plan.md#rg-701-회귀-테스트) · [RG-702](mvp-plan.md#rg-702-산출물-정리)*
...
- 운영 프로세스에서는 **층별장이 현장 업무(검사 일정 등록·검사 실행 등)를 수행**하고, 관리자는 정책·현황 관리와 지원 역할에 집중한다. 관리자 계정에도 일정/검사 API 권한은 존재하지만, 실제 현장 흐름은 층별장 주도로 진행한다.
  - *Post-MVP*: 관리자가 일정 등록/수정을 수행하고 해당 층별장에게 알림을 발송하는 운영 플로우를 확장 도입한다.
